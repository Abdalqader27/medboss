...
/// @nodoc
@JsonSerializable()
class _$_FolderModel extends _FolderModel with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'FolderModel(className: $className, objectId: $objectId, createdAt: $createdAt, updatedAt: $updatedAt, universityId: $universityId, parentId: $parentId, hasFiles: $hasFiles, name: $name, id: $id)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, className, objectId, createdAt,
      updatedAt, universityId, parentId, hasFiles, name, id);
...
abstract class _FolderModel extends FolderModel {
  const factory _FolderModel(
      ...
      @JsonKey(name: 'ID') required final String id}) = _$_FolderModel;
